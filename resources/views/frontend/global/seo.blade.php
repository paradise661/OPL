...
<title>{{ $title ?? '' }} - Ohm Pharmaceuticals</title>
@if ($description)
...
<meta property="og:title" content="{{ $title ?? '' }} - Ohm Pharmaceuticals" />
@if ($description)
    <meta property="og:description" content="{{ $description ?? '' }}" />
@endif
<meta property="og:url" content="{{ Request::url() }}" />
<meta property="og:site_name" content="{{ $title ?? '' }} - Ohm Pharmaceuticals" />
<meta property="article:publisher" content="https://www.facebook.com/opm/" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@graph":[
                ...
                },
                {
                    "@type":"Organization",
                    "@id":"{{ url('/') }}/#organization",
                    "name":"Ohm Pharmaceuticals & Expedition P. Ltd",
                    "url":"{{ url('/') }}/",
                    "logo":{
                        "@type":"ImageObject",
                        "inLanguage":"en-US",
                        ...
                        "height":{{ $logoheight ?? '' }},
                        "width":{{ $logowidth ?? '' }},
                        "caption":"Ohm Pharmaceuticals & Expedition P. Ltd"
                    },
                    "image":{
                        "@id":"{{ url('/') }}/#/schema/logo/image/"
                    },
                    "sameAs":[
                        "https://www.facebook.com/opm/",
                        "https://www.instagram.com/opm/",
                    ]
                }
            ]
        }
